			...
			<tr>
			  <td colspan="2"  class="font1"><table width="100%" border="0">
                <tr>
                  ...
                  <tr>
                  <td width="22%" valign="top" class="heading">Sharing: </td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="35%" class="comb-value"><label>
            <input name="Submit" type="submit" class="txtbox4" value="Prints this Document " onClick="window.print();return false;" />
          </label></td>
          <td width="3%">&nbsp;</td>
          <td width="26%"><label>
