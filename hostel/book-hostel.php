...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
			<h3 style="color: red" align="left">Hostel already registered by you</h3>
				<?php }
				else{
							echo "";
							}			
...
<div class="form-group">
<label class="col-sm-2 control-label">Parent/Guardian  Relation : </label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Parent/Guardian Contact no : </label>
<div class="col-sm-8">
